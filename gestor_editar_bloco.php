...
<head>
    ...
    <title>Gestor - Editar Bloco</title>
            ...
            <div class="col-md-6">
                <div class="card shadow border-0 rounded-4">
                    <div class="card-body p-4">
                        <h2 class="fw-bold text-center mb-4">Editar Bloco</h2>
                        ...
                        <form id="formAdicionarAmbiente">
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                <a href="gestor_lista_blocos.php" class="btn btn-secondary py-2 w-40 fw-bold">Cancelar</a>
