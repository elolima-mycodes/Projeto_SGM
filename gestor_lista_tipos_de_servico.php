...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <div class="text-center mb-5">
            <a href="gestor_adicionar_servico.php" class="btn btn-adicionar shadow">
                <i class="bi bi-plus-lg me-2"></i> Adicionar Tipo de serviço
            </a>
        </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <tr>
                            <th>#1</th>
                            <th>Elétrica</th>
                            <th><a href="gestor_editar_servico.php" class="btn btn-warning mb-3 mt-2"><i class="bi bi-pencil me-2"></i>Editar</a></th>
